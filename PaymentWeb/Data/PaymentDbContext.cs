...
{
    public class PaymentDbContext: IdentityDbContext<ApplicationUser>
    {
        ...
        public PaymentDbContext(DbContextOptions<PaymentDbContext> options, IHttpContextAccessor _httpContextAccessor) : base(options)
        {
